...
export const SignUp: FC<{}> = () => {
  ...
  const initialValues: MyFormValues = {userName: '',email: '',password: '',confirmPassword: '' }
  return (
    ...
    >
      <Form className='register-form'>
        ...
        <ErrorMessage  component="userName" className='error' name="userName" />
        ...
        <ErrorMessage  component="password"  className='error' name="password" />

        <label htmlFor="confirmPassword">Confirm Password</label>
        <Field name="confirmPassword" type="password" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"/>
        <ErrorMessage component="confirmPassword"  className='error' name="confirmPassword" />
